...
class Mail:
    ...
    ### ------------------------------------------------------------
    def __init__(self, settings, debug_mode=False):
    ...
    def send(self):
        ...
        msg['Date'] = formatdate()
        if self.debug_mode:
            print('### Mail.send() | From: {}'.format(msg['From']))
            print('### Mail.send() | To: {}'.format(msg['To']))
            print('### Mail.send() | Cc: {}'.format(msg['Cc']))
            print('### Mail.send() | Bcc: {}'.format(msg['Bcc']))
            print('### Mail.send() | Subject: {}'.format(msg['Subject']))
